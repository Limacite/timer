...
>>>>>>> Stashed changes
			...
			case 'DoTimer':
				var r = model.inStart ? false : true;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{inStart: r}),
...
var $author$project$Main$DecrementInterval = {$: 'DecrementInterval'};
var $author$project$Main$DecrementLimit = {$: 'DecrementLimit'};
var $author$project$Main$DoTimer = {$: 'DoTimer'};
var $author$project$Main$EditInterval = function (a) {
	return {$: 'EditInterval', a: a};
};
var $author$project$Main$EditLimit = function (a) {
	return {$: 'EditLimit', a: a};
};
var $author$project$Main$IncrementInterval = {$: 'IncrementInterval'};
var $author$project$Main$IncrementLimit = {$: 'IncrementLimit'};
...
var $author$project$Main$view = function (model) {
	var w = $elm$core$String$fromInt(
		model.working ? model.counter : model.limit);
	var l = $elm$core$String$fromInt(model.limit);
	var i = $elm$core$String$fromInt(model.interval);
	var c = $elm$core$String$fromInt(model.counter);
	var btClass = model.inStart ? 'bt stop-bt' : 'bt';
							...
							_List_fromArray(
								[
									...
									A2(
										...
										_List_Nil,
										{
											label: $mdgriffith$elm_ui$Element$text(bt),
											onPress: $elm$core$Maybe$Just($author$project$Main$DoTimer)
										})),
									A2(
									$mdgriffith$elm_ui$Element$el,
									_List_fromArray(
									...
									A2(
										...
										_List_Nil,
										{
											...
											onPress: $elm$core$Maybe$Just($author$project$Main$ChangePlayer)
										}))
								]))
						])),
					A2(
								...
								[
									...
									A2(
											...
											]),
										{
											label: A2(
												...
												_List_Nil,
												$mdgriffith$elm_ui$Element$text('')),
											onChange: $author$project$Main$EditLimit,
									...
									_List_fromArray(
										[
											...
											{
												label: $mdgriffith$elm_ui$Element$text('Λ'),
												onPress: $elm$core$Maybe$Just($author$project$Main$IncrementLimit)
											}),
											A2(
											$mdgriffith$elm_ui$Element$Input$button,
											_List_fromArray(
											...
											{
												label: $mdgriffith$elm_ui$Element$text('V'),
												onPress: $elm$core$Maybe$Just($author$project$Main$DecrementLimit)
											})
										]))
								]))
						])),
								...
								[
									...
									A2(
											...
											]),
										{
											label: A2(
												...
												_List_Nil,
												$mdgriffith$elm_ui$Element$text('')),
											onChange: $author$project$Main$EditInterval,
											placeholder: $elm$core$Maybe$Nothing,
											text: i
										})),
									A2(
									...
									_List_fromArray(
										[
											...
											{
												label: $mdgriffith$elm_ui$Element$text('Λ'),
												onPress: $elm$core$Maybe$Just($author$project$Main$IncrementInterval)
											}),
											A2(
											$mdgriffith$elm_ui$Element$Input$button,
											_List_fromArray(
											...
											{
												label: $mdgriffith$elm_ui$Element$text('V'),
												onPress: $elm$core$Maybe$Just($author$project$Main$DecrementInterval)
											})
										]))
								]))
						]))
